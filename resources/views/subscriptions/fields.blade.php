...
<div class="row container-fluid px-4">
    ...
    <div class="form-group col-sm-6">
        ...
        @if (isset($subscription))
            {!! Form::text("value", $subscription->value, ["class" => "form-control money-mask", 'required' => true]) !!}
        @else
    ...
    <div class="form-group col-md-12">
        ...
        @if (isset($subscription))
            {!! Form::textarea("description", $subscription->description, ["class" => "form-control"]) !!}
        @else
    ...
    <div class="form-group col-sm-6">
        ...
        @if (isset($subscription))
            {!! Form::number("quantity_vacancies", $subscription->quantity_vacancies, ["class" => "form-control number-mask"]) !!}
        @else
     ...
     <div class="form-group col-sm-6">
        ...
        @if (isset($subscription))
            {!! Form::text("commercial_description", $subscription->commercial_description, ["class" => "form-control"]) !!}
        @else
