...
@section("content")
    <div class="container-fluid">
        ...
        <div class="box box-primary">
            ...
            <a href="{{ route('companies.all-subscriptions', request()->company_id) }}" class="btn btn-success mt-2"><i class="fas fa-arrow-circle-left"></i> Voltar</a>
        </div>
    </div>
    ...
    {{-- @include('layouts.datatables_js') --}}
        ...
        <script type="text/javascript">
            $(function(){
                ...
                let subscriptionId = @json(request()->subscription_id);
                let route = "{{ route('companies.get-subscriptions-members', [':param1', ':param2']) }}";

                route = route.replace(":param1", companyId).replace(':param2', subscriptionId);
