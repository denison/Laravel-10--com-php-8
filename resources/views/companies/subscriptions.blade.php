        ...
        <div class="box box-primary">
            <section class="content-header">
                <div class="row" style="display: flex; align-items: center;">
                    <div class="col-sm-6">
                        <h1 class="title-header" style="margin: 0;">{!! mb_strtoupper(\Lang::choice("tables.subscriptions", "p"), "UTF-8") !!}</h1>
                    </div>

                    <div class="col-sm-6">
                        <a class="table-header-button float-right" style="margin: 0;" href="{{ route('companies.create-subscription', request()->company_id) }}"><i class="fas fa-plus table-header-icon"></i> <span class="table-header-text">{!! mb_strtoupper(\Lang::get("text.add"), "UTF-8") !!}<span></a>
                    </div>
                </div>
            </section>
